        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <div>
            <div className="flex items-center space-x-3 mb-2 sm:mb-4">
              ...
              <div>
                <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold">Class Management</h1>
                <p className="text-sm sm:text-base lg:text-lg text-blue-100">Organize and manage your Quran classes</p>
              </div>
            </div>
          </div>
          <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            <DialogTrigger asChild>
              <Button
                className="bg-white text-blue-600 hover:bg-blue-50 shadow-lg hover:shadow-xl transition-all duration-300 rounded-xl px-4 sm:px-6 py-2 sm:py-3 w-full sm:w-auto"
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 sm:space-y-6 mt-4 sm:mt-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="startTime" className="text-sm sm:text-base font-semibold text-gray-700">
                      Start Time
                    </Label>
                    <Input
                      id="startTime"
                      ...
                      {...register('startTime')}
                      className={`rounded-xl border-2 transition-all duration-200 ${
                        errors.startTime ? 'border-red-300 focus:border-red-500' : 'border-gray-200 focus:border-blue-500'
                      }`}
                      disabled={!isSuperAdmin}
                    />
                    {errors.startTime && (
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="endTime" className="text-sm sm:text-base font-semibold text-gray-700">
                      End Time
                    </Label>
                    <Input
                      id="endTime"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="ageMin" className="text-sm sm:text-base font-semibold text-gray-700">
                      Minimum Age
                    </Label>
                    <Input
                      id="ageMin"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="ageMax" className="text-sm sm:text-base font-semibold text-gray-700">
                      Maximum Age
                    </Label>
                    <Input
                      id="ageMax"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="maxStudents" className="text-sm sm:text-base font-semibold text-gray-700">
                      Maximum Students
                    </Label>
                    <Input
                      id="maxStudents"
                      ...
                      className={`rounded-xl border-2 transition-all duration-200 ${
                        errors.maxStudents ? 'border-red-300 focus:border-red-500' : 'border-gray-200 focus:border-blue-500'
                      }`}
                      disabled={!isSuperAdmin}
                    />
                    {errors.maxStudents && (
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="teacherId" className="text-sm sm:text-base font-semibold text-gray-700">
                ...
                <div className="flex flex-col sm:flex-row justify-end space-y-4 sm:space-y-0 sm:space-x-4 pt-4 sm:pt-6 border-t">
                  ...
                  <Button
                    type="submit"
                    className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white rounded-xl px-4 sm:px-6 py-2 w-full sm:w-auto shadow-lg hover:shadow-xl transition-all duration-300"
                    disabled={!isSuperAdmin}
                  >
            ...
            <Card className="border-0 shadow-lg rounded-2xl bg-white">
              <CardContent className="text-center py-8 sm:py-12">
                <div className="w-16 sm:w-20 h-16 sm:h-20 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-6">
                  <BookOpen className="w-8 sm:w-10 h-8 sm:h-10 text-gray-400" />
                </div>
                <h3 className="text-lg sm:text-xl lg:text-2xl font-semibold text-gray-900 mb-2 sm:mb-3">No Classes Found</h3>
                <p className="text-sm sm:text-base text-gray-500 mb-4 sm:mb-6">Get started by creating your first class</p>
                <Button
                  onClick={() => setIsDialogOpen(true)}
                  className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white rounded-xl px-4 sm:px-6 py-2"
                  disabled={!isSuperAdmin}
                >
              ...
              >
                <CardHeader className="pb-3 sm:pb-4">
                  <div className="flex items-start justify-between">
                    <div className="flex items-center space-x-2 sm:space-x-3">
                      ...
                      <div>
                        <CardTitle className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 group-hover:text-blue-600 transition-colors">
                          {classItem.name}
                        </CardTitle>
                ...
                <CardContent className="space-y-3 sm:space-y-4">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                    <div className="flex items-center space-x-2 p-2 sm:p-3 bg-gray-50 rounded-xl">
                      <Clock className="w-3 sm:w-4 h-3 sm:h-4 text-gray-500" />
                      <div>
                        <div className="text-sm sm:text-base font-medium text-gray-900">
                          {classItem.startTime} - {classItem.endTime}
                        </div>
                        <div className="text-xs sm:text-sm text-gray-500">Class Time</div>
                      </div>
                    </div>

                    <div className="flex items-center space-x-2 p-2 sm:p-3 bg-gray-50 rounded-xl">
                      <Users className="w-3 sm:w-4 h-3 sm:h-4 text-gray-500" />
                      <div>
                        <div className="text-sm sm:text-base font-medium text-gray-900">
                  ...
                  {classItem.teacher && (
                    <div className="flex items-center space-x-2 p-2 sm:p-3 bg-emerald-50 rounded-xl">
                      <GraduationCap className="w-3 sm:w-4 h-3 sm:h-4 text-emerald-600" />
                      <div>
                        <div className="text-sm sm:text-base font-medium text-gray-900">{classItem.teacher.name}</div>
                        <div className="text-xs sm:text-sm text-emerald-600">Assigned Teacher</div>
                      </div>
                    </div>
                  )}
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between items-center">
                      <span className="text-sm sm:text-base font-medium text-gray-700">Class Utilization</span>
                      <span className="text-sm sm:text-base text-gray-500">{Math.round(utilization)}%</span>
                    </div>
                    <div className="relative">
                      <div className="w-full bg-gray-200 rounded-full h-2 sm:h-3">
                        <div
                          className={`h-2 sm:h-3 rounded-full transition-all duration-500 bg-gradient-to-r ${getUtilizationColor(
                            utilization,
                          )}`}
